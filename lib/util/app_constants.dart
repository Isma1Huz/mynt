...
import 'package:mynt/data/model/response/on_boarding_model.dart';

import 'images.dart';

class AppConstants {
  static const String APP_NAME = 'Mynt';
  //demo


  static const String BASE_URL = 'http://app.mynt.co.ke';
  // static const String BASE_URL = '192.168.1.25';
  // //fun
  // static const String BASE_URL = 'https://Mynt-admin.6am.fun';
  ...
  static List<LanguageModel> languages = [
    ...
    LanguageModel(imageUrl: Images.swahili, languageName: 'Swahili', countryCode: 'SW', languageCode: 'sw'),
